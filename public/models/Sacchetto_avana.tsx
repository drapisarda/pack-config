...
export function Model(props) {
  ...
  const defaultMaterial = materials.Plastica5 as MeshPhysicalMaterial
  defaultMaterial.map = props.texture || defaultMaterial.map
  materials.Materiale.map = props.texture || materials.Materiale.map

  return (
    <group {...props} dispose={null}>
      <group position={[0, 0, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.187}>
